...
class home extends controller
{
    ...
    public function index()
    {
        ...
        $product_nike = $this->ProductModels->select_array('*',['cateID' => 41],'id desc');
        $product_puma = $this->ProductModels->select_array('*',['cateID' => 42],'id desc');
        $product_adidas = $this->ProductModels->select_array('*',['cateID' => 43],'id desc');
        $product_thuongdinh = $this->ProductModels->select_array('*',['cateID' => 44],'id desc');
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $mail = $this->SendMail->send('Nhận thông tin sản phẩm',$email, 'Đây là nội dung', 'lethanhphata6@gmail.com');
            if($email){
        ...
        $data = [
            'page'          => 'home/index',
            'product'       => $product,
            'product_nike'       => $product_nike,
            'product_puma'       => $product_puma,
            'product_adidas'       => $product_adidas,
            'product_thuongdinh'       => $product_thuongdinh,
