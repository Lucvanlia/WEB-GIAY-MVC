...
<section class="cart__container detail__product">
    <div class="container">
        <div class="cart">
            <h3>Giỏ hàng</h3>
            ...
            <div class="list__items">
                <table class="table">
                    <thead>
                        ...
                        <th class="text-justify" scope="row">Tên sản phẩm</th>
                        <th class="text-justify" scope="row">Hình ảnh</th>
                        <th class="text-justify" scope="row">Đơn giá</th>
                        <th class="text-justify" scope="row">Số lượng</th>
                        <th class="text-justify" scope="row">Tổng giá</th>
                        <th class="text-justify" scope="row">Thao tác</th>
                    </thead>
        ...
        <div class="payment">
            <div class="box__left">
                Không có sản phẩm nào ! <br><br><br><br><a href="#" class="payment__btn"  class="btn btn-primary btn-cart m-0">Tiếp tục mua hàng</a>
            </div>
        </div>
        <?php } ?>
    </div>
