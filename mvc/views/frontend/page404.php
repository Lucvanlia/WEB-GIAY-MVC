                ...
                <ul class="w-100 float-left">
                  <li>
                    <table class="table table-striped">
                      <tbody>
                        <tr>
                          <td class="text-center"><a href="#"><img src="public/lib_fronend/img/products/01.jpg" alt="01" title="01" height="104" width="80"></a></td>
	  ...
	  <div class="slider-wrapper my-40 my-sm-25 float-left w-100">
		...
		<div class="ttloading-bg"></div>
	  	<div class="slider slider-for owl-carousel">
			<div>
				<a href="#">
					<img src="public/lib_fronend/img/slider/sample-01.jpg" alt="" height="800" width="1600"/>
				</a>
			...
			<div>
				<a href="#">
					<img src="public/lib_fronend/img/slider/sample-02.jpg" alt="" height="800" width="1600"/>
				</a>
				...
				<div class="ttbannerblock container text-center">
					<div class="row">
					  <div class="ttbanner1 ttbanner col-sm-6 col-xs-6 left-to-right hb-animate-element">
						<div class="ttbanner-img"><a href="#"><img src="public/lib_fronend/img/banner/cms-01.jpg" alt="cms-01" height="600" width="630"></a></div>
						  ...
						  <div class="ttbanner2 ttbanner col-sm-6 col-xs-6 right-to-left hb-animate-element">
                                                      <div class="ttbanner-img"><a href="#"><img src="public/lib_fronend/img/banner/cms-02.jpg" alt="cms-02" height="600" width="630"></a></div>
							<div class="ttbanner-inner d-inline-block align-top float-none">
			...
			<div class="row">
				...
				<div class="tabs">
					<ul class="nav nav-tabs justify-content-center">
						<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#ttfeatured-main" id="featured-tab"><div class="tab-title">Featured</div></a></li>					</ul>
				</div>
								...
								<div class="product-thumb">
									<div class="image zoom">
										<a href="product-details.html">
											<img src="public/lib_fronend/img/products/02.jpg" alt="02" height="385" width="512"/>
											<img src="public/lib_fronend/img/products/03.jpg" alt="03" class="second_image img-responsive" height="501" width="385"/>										</a>
										<div class="flags">
					...
					<div class="ttnew-content products grid owl-carousel" id="owl2">
						<div class="product-layouts">
							<div class="product-thumb">
								<div class="image zoom">
									<a href="product-details.html">
										<img src="public/lib_fronend/img/products/01.jpg" alt="01" height="501" width="385"/>	
										<img src="public/lib_fronend/img/products/02.jpg" alt="02" class="second_image img-responsive" height="501" width="385"/>									</a>	
					...
					<div class="ttbestseller-content products grid owl-carousel" id="owl3">
						...
						<div class="product-layouts">
							<div class="product-thumb">
								<div class="image zoom">
									<a href="product-details.html">
										<img src="public/lib_fronend/img/products/02.jpg" alt="02" height="501" width="385"/>		
										<img src="public/lib_fronend/img/products/03.jpg" alt="03" class="second_image img-responsive" height="501" width="385"/></a></div>
								<div class="thumb-description">
									<div class="caption">
						...
						<div class="product-layouts">
							<div class="product-thumb">
								<div class="image zoom">
									<a href="product-details.html">
										<img src="public/lib_fronend/img/products/03.jpg" alt="03" height="501" width="385"/>
										<img src="public/lib_fronend/img/products/04.jpg" alt="04" class="second_image img-responsive" height="501" width="385"/></a></div>
								<div class="thumb-description">
									<div class="caption">
						...
						<div class="product-layouts">
							<div class="product-thumb">
								<div class="image zoom">
									<a href="product-details.html">
										<img src="public/lib_fronend/img/products/04.jpg" alt="03" height="501" width="385"/>		
										<img src="public/lib_fronend/img/products/05.jpg" alt="05" class="second_image img-responsive" height="501" width="385"/></a></div>
								<div class="thumb-description">
									<div class="caption">
						...
						<div class="product-layouts">
							<div class="product-thumb">
								<div class="image zoom">
									<a href="product-details.html">
										<img src="public/lib_fronend/img/products/05.jpg" alt="03" height="501" width="385"/>		
										<img src="public/lib_fronend/img/products/06.jpg" alt="06" class="second_image img-responsive" height="501" width="385"/>									</a>									</div>
								<div class="thumb-description">
									<div class="caption">
						...
						<div class="product-layouts">
							<div class="product-thumb">
								<div class="image zoom">
									<a href="product-details.html">
										<img src="public/lib_fronend/img/products/06.jpg" alt="03" height="501" width="385"/>										</a>									</div>
								<div class="thumb-description">
									<div class="caption">
						...
						<div class="product-layouts">
							<div class="product-thumb">
								<div class="image zoom">
									<a href="product-details.html">
										<img src="public/lib_fronend/img/products/07.jpg" alt="03" height="501" width="385"/>										</a>									</div>
								<div class="thumb-description">
									<div class="caption">
										<h4 class="product-title text-capitalize"><a href="product-details.html">Tropical Shirt Dress</a></h4>
									</div>
						...
						<div class="product-layouts">
							<div class="product-thumb">
								<div class="image zoom">
									<a href="product-details.html">
										<img src="public/lib_fronend/img/products/08.jpg" alt="03" height="501" width="385"/></a></div>
								<div class="thumb-description">
									<div class="caption">
  ...
  <div class="ttbannerblock container">
    <div class="row">
      <div class="ttbanner1 ttbanner col-sm-6 col-xs-6">
        <div class="ttbanner-img"><a href="#"><img src="public/lib_fronend/img/banner/cms-03.jpg" alt="cms-03" height="600" width="400"></a></div>
      ...
      <div class="ttbanner2 ttbanner col-sm-6">
        <div class="ttbanner-img"><a href="#"><img src="public/lib_fronend/img/banner/cms-04.jpg" alt="cms-04" height="600" width="400"></a></div>
        <div class="ttbanner-inner">
          <div class="ttbanner-desc text-center">
					...
					<div class="row">
							...
							<div class="product-layouts">
								<div class="product-thumb">
									<div class="image zoom">
										<a href="#">
											<img src="public/lib_fronend/img/products/04.jpg" alt="04" height="501" width="385"/>
											<img src="public/lib_fronend/img/products/05.jpg" alt="05" class="second_image img-responsive" height="501" width="385"/></a></div>
									<div class="thumb-description">
										<div class="caption">
							...
							<div class="product-layouts">
								<div class="product-thumb">
									<div class="image zoom">
										<a href="#">
											<img src="public/lib_fronend/img/products/05.jpg" alt="05" height="501" width="385"/>
											<img src="public/lib_fronend/img/products/06.jpg" alt="06" class="second_image img-responsive" height="501" width="385"/>										</a>									</div>
									<div class="thumb-description">
										<div class="caption">
							...
							<div class="product-layouts">
								<div class="product-thumb">
									<div class="image zoom">
										<a href="#">
											<img src="public/lib_fronend/img/products/06.jpg" alt="06" height="501" width="385"/>	
											<img src="public/lib_fronend/img/products/07.jpg" alt="07" class="second_image img-responsive" height="501" width="385"/></a></div>
									<div class="thumb-description">
										<div class="caption">
											<h4 class="product-title text-capitalize"><a href="product-details.html">Printed Dugaree with T-Shirt</a></h4>
										</div>
				...
				<div class="smartblog-content owl-carousel">
					...
					<div class="item">
						<div class="ttblog_image_holder">
							<a href="#">
								<img src="public/lib_fronend/img/banner/blog-01.jpg" alt="blog-01" width="415" height="269">							</a>
					...
					<div class="item">
						<div class="ttblog_image_holder">
							<a href="#">
								<img src="public/lib_fronend/img/banner/blog-02.jpg" alt="blog-02" width="415" height="269">							</a>
								<span class="blogicons">
					...
					<div class="item">
						<div class="ttblog_image_holder">
							<a href="#">
								<img src="public/lib_fronend/img/banner/blog-03.jpg" alt="blog-03" width="415" height="269">							</a>
																<span class="blogicons">
					...
					<div class="item">
						<div class="ttblog_image_holder">
							<a href="#">
								<img src="public/lib_fronend/img/banner/blog-04.jpg" alt="blog-04" width="415" height="269">							</a>
								<span class="blogicons">
					...
					<div class="item">
						<div class="ttblog_image_holder">
							<a href="#">
								<img src="public/lib_fronend/img/banner/blog-05.jpg" alt="blog-05" width="415" height="269">							</a>
								<span class="blogicons">
			...
			<div id="ttbrandlogo" class="my-40 my-sm-25 bottom-to-top hb-animate-element">
				...
				<div class="tt-brand owl-carousel">
					<div class="item">
						<a href="#"><img src="public/lib_fronend/img/logos/brand-logo-01.png" alt="brand-logo-01" width="140" height="100"></a>
					</div>
					<div class="item">
						<a href="#"><img src="public/lib_fronend/img/logos/brand-logo-02.png" alt="brand-logo-02" width="140" height="100"></a>
					</div>
					<div class="item">
						<a href="#"><img src="public/lib_fronend/img/logos/brand-logo-03.png" alt="brand-logo-03" width="140" height="100"></a>
					</div>
					<div class="item">
						<a href="#"><img src="public/lib_fronend/img/logos/brand-logo-04.png" alt="brand-logo-04" width="140" height="100"></a>
					</div>
					<div class="item">
						<a href="#"><img src="public/lib_fronend/img/logos/brand-logo-05.png" alt="brand-logo-05" width="140" height="100"></a>
					</div>
					<div class="item">
						<a href="#"><img src="public/lib_fronend/img/logos/brand-logo-06.png" alt="brand-logo-06" width="140" height="100"></a>
					</div>
				</div>
				</div>
			</div>
      ...
      <div class="row">
        <div class="col-md-2 footer-cms footer-column">
			<div class="ttcmsfooter">
              <div class="footer-logo"><img src="public/lib_fronend/img/logos/footer-logo.png" alt="footer-logo" width="200" height="50"></div>
				...
				<div class="col-md-6 left-columm">
						...
						<div class="tab-pane active" id="product-1" role="tabpanel" aria-labelledby="product-tab-1">
							<div class="single-img img-full">
								<a href="img/products/01.jpg"><img src="public/lib_fronend/img/products/01.jpg" class="img-fluid" alt="" width="368" height="478"></a>
							</div>
						</div>
						<div class="tab-pane" id="product-2" role="tabpanel" aria-labelledby="product-tab-2">
							<div class="single-img">
								<a href="img/products/02.jpg"><img src="public/lib_fronend/img/products/02.jpg" class="img-fluid" alt="" width="368" height="478"></a>
							</div>
						</div>
						<div class="tab-pane" id="product-3" role="tabpanel" aria-labelledby="product-tab-3">
							<div class="single-img">
								<a href="img/products/03.jpg"><img src="public/lib_fronend/img/products/03.jpg" class="img-fluid" alt="" width="368" height="478"></a>
							</div>
						</div>
						<div class="tab-pane" id="product-4" role="tabpanel" aria-labelledby="product-tab-4">
							<div class="single-img">
								<a href="img/products/04.jpg"><img src="public/lib_fronend/img/products/04.jpg" class="img-fluid" alt="" width="368" height="478"></a>
							</div>
						</div>
						<div class="tab-pane" id="product-5" role="tabpanel" aria-labelledby="product-tab-5">
							<div class="single-img">
								<a href="img/products/05.jpg"><img src="public/lib_fronend/img/products/05.jpg" class="img-fluid" alt="" width="368" height="478"></a>
							</div>
						</div>
				</div>
				<div class="small-image-list float-left w-100"> 
                                <div class="nav-add small-image-slider-single-product-tabstyle-3 owl-carousel" role="tablist">
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="product-tab-1" href="#product-1" class="img active"><img src="public/lib_fronend/img/products/01.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="product-tab-2" href="#product-2" class="img"><img src="public/lib_fronend/img/products/02.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="product-tab-3" href="#product-3" class="img"><img src="public/lib_fronend/img/products/03.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="product-tab-4" href="#product-4" class="img"><img src="public/lib_fronend/img/products/04.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="product-tab-5" href="#product-5" class="img"><img src="public/lib_fronend/img/products/05.jpg" class="img-fluid" alt=""></a>
                                    </div>
                                </div>
                            </div>
				</div>
		...
		<div class="modal-body">
			...
			<div class="row">
				<div class="col-md-5 col-sm-4 col-xs-12 product-img float-left">
					<img src="public/lib_fronend/img/products/01.jpg" class="img-responsive" alt="01">
				</div>
...
<div class="compare-wrapper float-left w-100">
  ...
  close
		...
		<div class="col-xs-12 col-sm-10 col-md-9 d-flex float-left align-items-center compare-right">
			...
			<div class="row">
				<div class="single-item col-sm-4 col-xs-4">
					...
					<div class="image"><img src="public/lib_fronend/img/products/01.jpg" class="img-fluid" alt=""></div>
				</div>
				<div class="single-item col-sm-4 col-xs-4">
					<div class="remove"></div>
					<div class="image"><img src="public/lib_fronend/img/products/02.jpg" class="img-fluid" alt=""></div>
				</div>
				<div class="single-item col-sm-4 col-xs-4">
					<div class="remove"></div>
					<div class="image"><img src="public/lib_fronend/img/products/03.jpg" class="img-fluid" alt=""></div>
				</div>
			</div>
			</div>
    ...
    <!-- Placed at the end of the document so the pages load faster -->
		<script src="public/lib_fronend/js/jquery.min.js"></script>
		<script src="public/lib_fronend/js/bootstrap.min.js"></script>
		<script src="public/lib_fronend/js/owl.carousel.min.js"></script>
		<script src="public/lib_fronend/js/custom.js"></script>
		<script src="public/lib_fronend/js/parallax.js"></script>
		<script src="public/lib_fronend/js/lightbox-2.6.min.js"></script>
		<script src="public/lib_fronend/js/ResizeSensor.min.js"></script>
		<script src="public/lib_fronend/js/theia-sticky-sidebar.min.js"></script>
		<script src="public/lib_fronend/js/inview.js"></script>
		<script src="public/lib_fronend/js/cookiealert.js"></script>
		<script src="public/lib_fronend/js/jquery.countdown.min.js"></script>
		<script src="public/lib_fronend/js/masonry.pkgd.min.js"></script>
		<script src="public/lib_fronend/js/imagesloaded.pkgd.min.js"></script>
		<script src="public/lib_fronend/js/jquery.zoom.min.js"></script>
		<script src="public/lib_fronend/js/jquery.lazy.min.js"></script>
