            ...
            <div class="box menu">
                <nav>
                    ...
                    <ul>
                        ...
                        <li><a
                                href="<?php //isset($val['children']) && $val['children'] != null ? 'javascript:void(0)': $val['url'] ?>"><?php // $val['name'] ?></a>
                            <?php //if($val['children'] != null){?>
                            <ul class="nav__children">
                                <?php //  foreach($val['children'] as $val_Child){?>
                                <li><a href="<?php //$val_Child['url'] ?>"><?php //$val_Child['name'] ?></a></li>
                                <?php //} ?>
                            </ul>
                            <?php // } ?>
                        </li>
